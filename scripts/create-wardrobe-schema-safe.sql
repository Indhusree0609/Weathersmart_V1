...
DROP POLICY IF EXISTS "Users can manage own item tags" ON public.wardrobe_item_tags;
...
DROP POLICY IF EXISTS "Users can view own wardrobe profiles" ON public.wardrobe_profiles;
DROP POLICY IF EXISTS "Users can insert own wardrobe profiles" ON public.wardrobe_profiles;
DROP POLICY IF EXISTS "Users can update own wardrobe profiles" ON public.wardrobe_profiles;
DROP POLICY IF EXISTS "Users can delete own wardrobe profiles" ON public.wardrobe_profiles;

CREATE POLICY "Users can view own wardrobe profiles" ON public.wardrobe_profiles
    FOR SELECT USING (auth.uid() = user_id);

CREATE POLICY "Users can insert own wardrobe profiles" ON public.wardrobe_profiles
    FOR INSERT WITH CHECK (auth.uid() = user_id);

CREATE POLICY "Users can update own wardrobe profiles" ON public.wardrobe_profiles
    FOR UPDATE USING (auth.uid() = user_id);

CREATE POLICY "Users can delete own wardrobe profiles" ON public.wardrobe_profiles
    FOR DELETE USING (auth.uid() = user_id);

-- Weather essentials policies
DROP POLICY IF EXISTS "Users can view own weather essentials" ON public.weather_essentials;
DROP POLICY IF EXISTS "Users can insert own weather essentials" ON public.weather_essentials;
DROP POLICY IF EXISTS "Users can update own weather essentials" ON public.weather_essentials;
DROP POLICY IF EXISTS "Users can delete own weather essentials" ON public.weather_essentials;

CREATE POLICY "Users can view own weather essentials" ON public.weather_essentials
    FOR SELECT USING (auth.uid() = user_id);

CREATE POLICY "Users can insert own weather essentials" ON public.weather_essentials
    FOR INSERT WITH CHECK (auth.uid() = user_id);

CREATE POLICY "Users can update own weather essentials" ON public.weather_essentials
    FOR UPDATE USING (auth.uid() = user_id);

CREATE POLICY "Users can delete own weather essentials" ON public.weather_essentials
    FOR DELETE USING (auth.uid() = user_id);
...
DROP TRIGGER IF EXISTS handle_updated_at_wardrobe_items ON public.wardrobe_items;
DROP TRIGGER IF EXISTS handle_updated_at_outfits ON public.outfits;
DROP TRIGGER IF EXISTS handle_updated_at_wardrobe_profiles ON public.wardrobe_profiles;
DROP TRIGGER IF EXISTS handle_updated_at_weather_essentials ON public.weather_essentials;
...
CREATE TRIGGER handle_updated_at_wardrobe_profiles
    BEFORE UPDATE ON public.wardrobe_profiles
    FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();

CREATE TRIGGER handle_updated_at_weather_essentials
